...
const TermAndConditionsUser: FC<{}> = () => {
    return (
        <Layout>
            <div
            ...
            >
                <div className="container">
                    <div className="bg-white p-5">
                        ...
                        <ul>
                            <li>
                                <strong>Comprador:</strong> Persona natural o jurídica que efectúa el pago de la reserva
                                y de la totalidad del precio del vehículo ofrecido en la Plataforma Tecnológica de WCAR.
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Usuario:</strong> Toda Persona natural o jurídica que, como destinatario final,
                                usa la Plataforma Tecnológica de WCAR para interactuar con sus funcionalidades, y para
                                adquirir los vehículos ofrecidos mediante la Plataforma Tecnológica.
                            </li>
                            <li>
                                <strong>Vehículo:</strong> Hacer referencia al automotor usado ofrecido por el vendedor
                                a través de la Plataforma Tecnológica.
                            </li>
                            <li>
                                <strong>Vendedor:</strong> Persona natural o jurídica que tiene la calidad de
                                propietario de un vehículo y desea venderlo a través de la Plataforma tecnológica de
                                WCAR.
                            </li>
                        </ul>

                        <div className="side side_top mb-3">
                            <h3>SOBRE LA PLATAFORMA TECNOLÓGICA Y FUNCIONAMIENTO. </h3>
                        </div>
                        ...
                        <div className="side side_top mb-3">
                            <h3>ACCESO A LA PLATAFORMA TECNOLÓGICA. </h3>
                        </div>
                        <p>
                        ...
                        <ul>
                            <li>
                                Restricciones relacionadas con el uso de la Plataforma Tecnológica
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                WCAR se reserva el derecho a investigar la ocurrencia de cualquiera de las anteriores
                                situaciones, y el Usuario se compromete a cooperar con cualquier autoridad competente en
                                la persecución de las personas que presuntamente puedan estar involucradas en tales
                                acciones.
                            </li>
                            <li>
                                Restricciones relacionadas con la propiedad intelectual de la Plataforma Tecnológica.
                                <br />
                                <br />
                        ...
                        <ul>
                            <li>
                                El Usuario deberá acceder a la página web y/o descargar la Plataforma Tecnológica en su
                                dispositivo móvil, y deberá completar satisfactoriamente los procedimientos de registro.
                                Al registrarse se deberá asegurar de que toda la información proporcionada sea exacta,
                                esté actualizada, completa y válida;
                            </li>
                            <li>
                                El Usuario se compromete a: (ii) Utilizar la Plataforma Tecnológica de buena fe y solo
                                para los fines de los presentes términos y condiciones; (ii) abstenerse de utilizarla
                                para fines ilegales;
                            </li>
                            <li>
                                El Usuario reconoce que WCAR podrá actualizar los requisitos del hardware y software del
                                teléfono móvil de la Plataforma Tecnológica de forma periódica;
                            </li>
                            <li>
                                Abstenerse de afectar intencionalmente el funcionamiento normal de la red y/o intentar
                                dañar los Servicios y/o la Plataforma Tecnológica;
                            </li>
                            <li>
                                Responder frente a WCAR por cualquier inexactitud o falsedad respecto de las
                                fotografías, información y/o características suministradas para publicarse en la
                                Plataforma Tecnológica.
                            </li>
                        </ul>
                        <div className="side side_top mb-3">
                            <h3>OBLIGACIONES DE WCAR.   </h3>
                        </div>
                        <ul>
                            <li>
                                Emplear sus mejores oficios y esfuerzos, así como los conocimientos y experiencia
                                profesional de sus dependientes en la búsqueda, para formalizar la compra y venta del
                                Vehículo.
                            </li>
                            <li>
                                Utilizar sus herramientas tecnológicas para que a través de ella se ofrezcan y
                                comercialicen los Vehículos.
                            </li>
                            <li>
                                Publicar las fotografías e información del vehículo de propiedad del Vendedor en la
                                Plataforma Tecnológica, la cual incluye página web y/o aplicativo móvil, durante el
                                tiempo de vigencia de la relación comercial o hasta el momento en que se logré la venta
                                (lo que primero ocurra), utilizando única y exclusivamente a la información obtenida en
                                el peritaje previo realizado al vehículo.
                            </li>
                            <li>
                                Guardar absoluta reserva y confidencialidad, tanto a nivel personal como respecto ade
                                sus empleados o dependientes, de toda la información que sea suministrada por el
                                Usuario, obligación que se extiende a sus empleados, trabajadores, asesores, consultores
                                y contratistas.
                            </li>
                            <li>Cualquier gestión necesaria para el cumplimiento de su objeto social.</li>
                        </ul>
                        <div className="side side_top mb-3">
                            <h3>LIMITACIÓN DE RESPOSABILIDAD DE WCAR. </h3>
                        </div>
                        <ul>
                            <li>
                                Limitaciones sobre la disponibilidad de los Vehículos.
                                <br />
                                <br />
                                El Usuario reconoce que la reserva del vehículo no es una oferta vinculante ni elimina
                                el vehículo de la oferta disponible en la Plataforma tecnológica, por lo tanto, WCAR se
                                reserva el derecho de confirmar la disponibilidad en un plazo no superior a 24 horas,
                                contadas a partir de la recepción del pago.
                            </li>
                            <li>
                                Limitaciones por uso indebido de la Plataforma Tecnológica.
                                <br />
                                <br />
                                WCAR no será responsable por el uso inadecuado de la Plataforma debido a: (i)
                                utilización de hardware no compatibles con la Plataforma Tecnológica; (ii) caso omiso
                                por parte del Usuario respecto de las recomendaciones tecnológicas, manuales y/o
                                procedimientos que sean recomendados por WCAR para la correcta prestación de servicio.
                            </li>
                            <li>
                                Limitaciones respecto a la disponibilidad de la Plataforma Tecnológica.
                                <br />
                                <br />
                                WCAR no garantiza disponibilidad o el tiempo de operación de la Plataforma Tecnológica.
                                En caso de inestabilidad o inconveniente técnicos mayores, WCAR no tendrá
                                responsabilidad alguna frente al Usuario, pero hará sus mejores esfuerzos para
                                estabilizar su operatividad.
                            </li>
                        </ul>
                        <div className="side side_top mb-3">
                            <h3>SUSPENSIÓN DE LA PLATAFORMA.</h3>
                        </div>
                        <p>
                        ...
                        <div className="side side_top mb-3">
                            <h3>DURACIÓN DE TÉRMINOS Y CONDICIONES. </h3>
                        </div>
                        <p>
                        ...
                        <p>
                            El Usuario podrá notificar a WCAR cualquier PQRS relacionado con los Términos y Condiciones
                            aquí previstos, comunicándose directamente con atención al cliente al Correo electrónico:
                        ...
                        <div className="side side_top mb-3">
                            <h3>INDEPENDENCIA DE LAS PARTES. </h3>
                        </div>
                        <p>
                        ...
                        <div className="side side_top mb-3">
                            <h3>CASO FORTUITO O FUERZA MAYOR.</h3>
                        </div>
                        <p>
                        ...
                        <div className="side side_top mb-3">
                            <h3>INDEMNIDAD Y RESPONSABILIDAD.</h3>
                        </div>
                        <p>
                        ...
                        <p>
                            Las Partes tratarán en forma estrictamente confidencial toda información no pública que
                        ...
                        <p>
                            ...
                            o su ejecución, se intentará resolver en primera instancia entre las Partes. Si
                            transcurridos treinta (30) días calendario de surgida la controversia ésta no se ha
                            resuelto, se intentará conciliación ante cualquier Centro de Conciliación autorizado de la
                            ciudad de Bogotá D.C. Si en esta instancia no se logra resolver la diferencia, las Partes se
                            someterán a los tribunales de la jurisdicción ordinaria de la ciudad de Bogotá D.C y a las
                            leyes colombianas.
                        </p>
                        <div className="side side_top mb-3">
                            <h3>LEY APLICABLE Y DOMICILIO CONTRACTUAL.</h3>
                        </div>
                        <p>
...
export default TermAndConditionsUser;
