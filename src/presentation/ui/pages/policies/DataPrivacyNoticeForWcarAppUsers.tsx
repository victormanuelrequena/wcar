...
const DataPrivacyNoticeForWcarAppUsers: FC<{}> = () => {
    return (
        <Layout>
            <div
            ...
            >
                <div className="container">
                    <div className="bg-white p-5">
                        ...
                        <p>
                            WCAR SAS, se compromete a proteger la privacidad de sus usuarios. Este Aviso de privacidad
                        ...
                        <ul>
                            <li>
                                Con empresas afiliadas: Podemos compartir su información con nuestras empresas
                                afiliadas, que son empresas que están bajo el control común de WCAR SAS.
                            </li>
                            <li>
                        ...
                        <div className="side side_top mb-3">
                            <h4 style={{ marginLeft: 16 }}>Cambios en este Aviso de privacidad</h4>
                        </div>
                        <p>
                            Podemos cambiar este Aviso de privacidad en cualquier momento. Cualquier cambio será
                            efectivo una vez sea publicado en esta página web.
                        </p>
                        <div className="side side_top mb-3">
                            <h4 style={{ marginLeft: 16 }}>Información adicional para usuarios de Colombia</h4>
                        </div>
                        <p>
                            En Colombia, la Ley 1581 de 2012 y el Decreto 1377 de 2013 establecen los principios y
                            deberes para el tratamiento de datos personales. WCAR cumple con estas normas y garantiza la
                            protección de los datos personales de sus usuarios.
                        </p>
                        <div className="side side_top mb-3">
                            <h4 style={{ marginLeft: 16 }}>Preguntas y comentarios</h4>
                        </div>
                        <p>
...
export default DataPrivacyNoticeForWcarAppUsers;
