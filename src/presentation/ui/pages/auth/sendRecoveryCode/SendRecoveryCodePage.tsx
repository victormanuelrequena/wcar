...
import SendRecoveryPasswordCodeUseCase, {
    SendRecoveryPasswordCodeUseCaseName,
} from "../../../../../domain/use_cases/auth/SendRecoveryPasswordCodeUseCase";
...
const SendRecoveryCodePage: FC<{}> = () => {
    ...
    const _handleSubmit = async (data: any) => {
        const response = await di
            .get<SendRecoveryPasswordCodeUseCase>(SendRecoveryPasswordCodeUseCaseName)
            .call(data.email);
        if (isRight(response)) {
    ...
    return (
        <div className="send_recovery_code_page">
            <Layout>
                        ...
                        <div className="col-md-4 content_page">
                            ...
                            <form onSubmit={handleSubmit(_handleSubmit)}>
                                ...
                                <div className="w-100 d-flex justify-content-center">
                                    <Link to={routes.signIn.relativePath} className="text-center text_orange my-3">
