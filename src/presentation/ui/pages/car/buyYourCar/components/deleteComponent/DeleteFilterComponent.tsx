    ...
    return (
        <div className="delete_filter_component">
            ...
            {(price?.min || price?.max) && (
                <div className="delete_filter_item">
                    <span>
                        {price.min ? CurrencyParse.toCop(price.min) : 0} -{" "}
                        {price.max ? CurrencyParse.toCop(price.max) : "..."}
                    </span>
                ...
                <Helmet>
                    ...
                    {type.id == "3" && (
                        <>
                            <meta
                                name="description"
                                content="¿Buscas Carros Sedan en Colombia? en wcar te entregamos toda la información que necesitas, porqué más que vender te aconsejamos.​"
                            />
                            <meta
                                name="keywords"
                                content="Carros Sedan, Carros Sedan Colombia, Auto Sedan, Aveo Sedan, Joy Sedan, mazda 2 sedan, chevrolet onix sedan, kia rio sedan, Sedan Usados, Compra Sedan Usado, Qué es un sedan"
                            />
                        </>
                    )}
                    {type.id == "6" && (
                        <>
                            <meta
                                name="description"
                                content="¡Carros Hatchback Colombia! En wcar te mostramos todas las opciones que hay en Colombia con carros usados 5 puertas con nuestra transparencia brutal. ​"
                            />
                            <meta
                                name="keywords"
                                content="Hatchback Colombia, Hatchback, Carros Hatchback usados, Hatchback la mejor opción en Bogotá, Hatchback la mejor opción en Bogotá, Los Mejores Hatchback en Colombia, Hachback Carros, Kia Rio Hatchback, Hyundai Accent Hatchback, Chevrolet Onix Hatchback, Mazda 3 Hatchback"
                            />
                        </>
                    )}
                    {type.id == "8" && (
                ...
                <div className="delete_filter_item">
                    ...
                    {tag.id == "5" && (
                        <Helmet>
                            ...
                            <meta
                                name="description"
                                content="¡Carros de lujo usados! En wcar te mostramos todas las opciones que hay en Colombia con los más exclusivos autos de gama alta del país.​"
                            />
                            <meta
                                name="keywords"
                                content="Carros de lujo usados, carros de gama alta usados, autos de lujo usados, carros de lujo para mujeres, autos de lujo para hombres, Top 5 de carros alta gama en Colombia"
                            />
                        </Helmet>
                    )}
                </div>
            )}
            {(rangeMileage?.min || rangeMileage?.max) && (
                <div className="delete_filter_item">
                    <span>
                        {rangeMileage.min ?? 0}km - {rangeMileage.max ?? "..."}km
                    </span>
                ...
                <div className="delete_filter_item">
                    ...
                    {fuel.id == "3" && (
                        <Helmet>
                            <meta
                                name="desciption"
                                content="¡Carros Híbridos Colombia! En wcar te mostramos todas las opciones que hay en Colombia con carros usados híbridos y tecnologías limpias. "
                            />
                            <meta
                                name="keywords"
                                content="Carros Híbridos Colombia, Tecnologías Limpias, Híbrido, Carros Híbridos, Vehículos híbridos, Hyundai Híbrido, Suzuki Híbrido, Toyota Híbrido, Mazda Híbrido"
                            />
                        </Helmet>
                    )}
                </div>
