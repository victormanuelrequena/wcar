                                ...
                                <div className="col-md-8 px-5 px-md-3 d-flex justify-content-around">
                                    <a href="mailto:contacto@wcar.co">
                                        <div className="card_contact">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="63" viewBox="0 0 64 63" fill="none">
                                                ...
                                                <path d="M41.496 23H23.504C22.9495 23 22.5 23.3755 22.5 23.8387V37.1613C22.5 37.6245 22.9495 38 23.504 38H41.496C42.0505 38 42.5 37.6245 42.5 37.1613V23.8387C42.5 23.3755 42.0505 23 41.496 23Z" stroke="#1E1E1E" stroke-width="2" />
                                                <path d="M22.5 23L32.9247 30L42.5 23.2294" stroke="#1E1E1E" stroke-width="2" />
                                            </svg>
                                    ...
                                    <a href="https://www.google.com/maps/search/?api=1&query=Calle+98a+%23+69B-35">
                                        <div className="card_contact">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="63" viewBox="0 0 64 63" fill="none">
                                                <circle cx="32" cy="31.5" r="31" fill="#00FEFE" stroke="#00FEFE" />
                                                <path d="M32.5 42C38.5751 42 43.5 37.0751 43.5 31C43.5 24.9249 38.5751 20 32.5 20C26.4249 20 21.5 24.9249 21.5 31C21.5 37.0751 26.4249 42 32.5 42Z" stroke="#1E1E1E" stroke-width="2" />
                                                <path d="M32.5 22V31.2058L37.5 35" stroke="#1E1E1E" stroke-width="2" />
                                            </svg>
